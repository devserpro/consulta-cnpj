...
**[GET] https://apigateway.serpro.gov.br/consulta-cnpj/v1/cnpj/99999999999999**: chamamos a url da API informando o CNPJ. No caso a url é "consulta-cnpj<span id="trialSpanUrl2"></span>/v1<span id="trialSpanVersao2"></span>/cnpj/{numero do CNPJ}"
